...
Cypress.Commands.add('SuporteTecnico', () => {
    ...
    cy.get('.mdn-Col-md-3 > div > .mdn-Heading').should('contain', 'Fale com a Claro');
    //Clicar card Suporte técnico
    cy.get('#category-card-1754')
      .click()
})