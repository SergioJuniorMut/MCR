...
describe('Fale com a Claro',()=>{
    ...
    it('Fale com a Claro - Fazer Sugestão',()=>{     
        //Assertiva - Fraselogias
        cy.get(el.titulo)
          .should('contain', 'Conta pra gente o que você pensa')
        cy.get(el.subTitulo)
          .should('contain' , 'Sua opinião é muito importante para melhorarmos nossos serviços. Vamos ler sua sugestão e te enviar uma resposta no e-mail')
